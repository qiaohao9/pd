module github.com/qiaohao9/pd/tests/client
...
require (
	...
	github.com/qiaohao9/pd v0.0.0-00010101000000-000000000000
	github.com/qiaohao9/pd/client v0.0.0-00010101000000-000000000000
...
replace (
	github.com/qiaohao9/pd => ../../
	github.com/qiaohao9/pd/client => ../../client
)
